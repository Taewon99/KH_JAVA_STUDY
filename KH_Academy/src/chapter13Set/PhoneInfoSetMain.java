...
public class PhoneInfoSetMain implements Menu {
	...
	public static void insertData(HashSet<PhoneInfo> list, int inputNumber) {
	...
	public static PhoneInfo searchData(HashSet<PhoneInfo> list, String phoneNumber) {
		PhoneInfo pi = null;
	...
	public static boolean deleteData(HashSet<PhoneInfo> list, String phoneNumber) {
		...
		while (it.hasNext()) {
			pi = it.next();
			if (pi.getPhoneNumber().equals(phoneNumber)) {
				it.remove();
				deleteFlag = true;
				break;
			}
	...
	private static void printData(HashSet<PhoneInfo> list) {
		Iterator<PhoneInfo> it = list.iterator();
